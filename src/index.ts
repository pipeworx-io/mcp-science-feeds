 ...
 * Science Feeds MCP.
 *
 * Science & space — research journals, science news and astronomy.
...
const PACK_LABEL = 'Science Feeds';
...
const FEEDS: Record<string, FeedDef> = {
  ...
  'ars-science': { title: "Ars Technica Science", url: "https://arstechnica.com/science/feed/", category: "science", source: "Ars Technica Science", description: "Science coverage." },
  'smithsonian-mag': { title: "Smithsonian", url: "https://www.smithsonianmag.com/rss/latest_articles/", category: "science", source: "Smithsonian Magazine", description: "Science, history & culture." },
  hakai: { title: "Hakai Magazine", url: "https://hakaimagazine.com/feed/", category: "science", source: "Hakai Magazine", description: "Coastal science & society." },
};

const tools: McpToolExport['tools'] = [
  {
    name: 'list_feeds',
    description: 'List the curated science & space feeds (id, title, category, source). Optionally filter by category (science) or keyword. Pass an id to read_feed.',
    inputSchema: {
      type: 'object',
      properties: {
        category: { type: 'string', description: 'Filter by category: science.' },
  ...
  {
    name: 'read_feed',
    description: 'Read a curated science & space feed by its id (from list_feeds). Returns normalized items (title, link, published, summary). Optionally filter items by keyword.',
    inputSchema: {
      type: 'object',
      properties: {
